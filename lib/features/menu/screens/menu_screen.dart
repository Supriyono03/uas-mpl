...
import 'package:facebook/features/memory/memory_screen.dart';
...
class _MenuScreenState extends State<MenuScreen> {
  ...
  User user = User(name: 'Le Co Dot', avatar: 'assets/images/user/lcd.jpg');
  User secondUser =
  ...
  final List<Widget> shortcuts = [
    ...
    Container(
      ...
      child: const Shortcut(
          img: 'assets/images/menu/game.png', title: 'Permainan'),
    ),
    Container(
      width: double.infinity,
      margin: const EdgeInsets.all(5),
      ...
      child: const Shortcut(
          img: 'assets/images/menu/order.png', title: 'Order dan Pembayaran'),
    ),
    Container(
      width: double.infinity,
      margin: const EdgeInsets.all(5),
      ...
      child: const Shortcut(
          img: 'assets/images/menu/badge.png', title: 'Video Permainan'),
    ),
    Container(
      width: double.infinity,
      margin: const EdgeInsets.all(5),
    ...
    Container(
      ...
      child: const Shortcut(
          img: 'assets/images/menu/ads.png', title: 'Iklan Terbaru'),
    ),
    Container(
      width: double.infinity,
      margin: const EdgeInsets.all(5),
      ...
      child:
          const Shortcut(img: 'assets/images/menu/group.png', title: 'Group'),
    ),
    Container(
      width: double.infinity,
      margin: const EdgeInsets.all(5),
    ...
    Container(
      ...
      child:
          const Shortcut(img: 'assets/images/menu/page.png', title: 'Halaman'),
    ),
    Container(
      width: double.infinity,
      margin: const EdgeInsets.all(5),
      ...
      child: const Shortcut(
          img: 'assets/images/menu/emergency.png', title: 'Emergency'),
    ),
    Container(
      width: double.infinity,
      margin: const EdgeInsets.all(5),
      ...
      child: const Shortcut(
          img: 'assets/images/menu/phone.png', title: 'Request From Device'),
    ),
  ];
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(
                            width: 60,
                            child: Text(
                              'Pusat Dukungan Mahasiswa - Universitas. Ilmu Pengetahuan Alam, Universitas Nasional Vietnam-HCM',
                              style: TextStyle(
                                color: Colors.black54,
                                fontSize: 12,
                              ),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: Text(
                          MenuScreen.viewMoreShortcuts ? 'Sembunyikan lebih sedikit' : 'Lihat lebih banyak',
                          style: const TextStyle(
                            color: Colors.black,
                          ),
                        ),
