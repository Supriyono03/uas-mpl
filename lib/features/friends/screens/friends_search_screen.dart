                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Berteman sejak Mei ${1 + random.nextInt(12)} năm ${2023 - random.nextInt(15)}',
                                                    style: const TextStyle(
                                                      color: Colors.black54,
                                                      fontSize: 15,
                                                    ),
                                        ...
                                        ListTile(
                                          ...
                                          title: Text(
                                            'Kirim pesan ke ${friends[i].user.name}',
                                            style: const TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.w500,
                                              fontSize: 16,
                                        ...
                                        ListTile(
                                          ...
                                          title: Column(
                                            ...
                                            children: [
                                              Text(
                                                'Berhenti mengikuti ${friends[i].user.name}',
                                                style: const TextStyle(
                                                  color: Colors.black,
                                                  fontWeight: FontWeight.w500,
                                                  fontSize: 16,
                                              ...
                                              const Text(
                                                'Tidak dapat melihat postingan lagi tetapi masih berteman.',
                                                style: TextStyle(
                                                  color: Colors.black54,
                                                  fontSize: 14,
                                                ),
                                        ...
                                        ListTile(
                                          ...
                                          title: Column(
                                            ...
                                            children: [
                                              Text(
                                                'Blokir halaman pribadi saya ${friends[i].user.name}',
                                                style: const TextStyle(
                                                  color: Colors.black,
                                                  fontWeight: FontWeight.w500,
                                                  fontSize: 16,
                                              ...
                                              Text(
                                                '${friends[i].user.name} tidak akan dapat melihat Anda atau menghubungi Anda di Facebook.',
                                                style: const TextStyle(
                                                  color: Colors.black54,
                                                  fontSize: 14,
                                                ),
                                        ...
                                        ListTile(
                                          ...
                                          title: Column(
                                            ...
                                            children: [
                                              Text(
                                                'Batalkan pertemanan ${friends[i].user.name}',
                                                style: const TextStyle(
                                                  color: Colors.red,
                                                  fontWeight: FontWeight.w500,
                                                  fontSize: 16,
                                              ...
                                              Text(
                                                'tidak berteman ${friends[i].user.name}',
                                                style: const TextStyle(
                                                  color: Colors.black54,
                                                  fontSize: 14,
                                                ),
