  ...
  final List<Comment> comments = [
    Comment(
      ...
      replies: [
        Comment(
          user: User(
              name: 'Prabowo', avatar: 'assets/images/user/vuonghongthuy.jpg'),
          content: 'ngasal aja',
          time: '1 menit',
          replies: [],
        ),
    ...
    Comment(
      user: User(name: 'Jokowi', avatar: 'assets/images/user/minhtuyen.jpg'),
      content: 'My Profile',
      time: '1 tuần',
                                                      ...
                                                      child: ListTile(
                                                        ...
                                                        title: const Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              'Tampilkan komentar terbaru terlebih dahulu. Beberapa komentar telah disaring.',
                                                              style: TextStyle(
                                                                fontSize: 15,
                                                                color: Colors
                                                                    .black54,
                                                      ...
                                                      child: ListTile(
                                                        ...
                                                        title: const Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              'Tampilkan semua komentar, termasuk konten yang mungkin merupakan spam. Komentar yang paling relevan akan muncul pertama kali.',
                                                              style: TextStyle(
                                                                fontSize: 15,
                                                                color: Colors
                                                                    .black54,
