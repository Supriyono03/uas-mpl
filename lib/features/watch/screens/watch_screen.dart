...
class _WatchScreenState extends State<WatchScreen> {
  ...
  final posts = [
    Post(
      ...
      time: '14 thg 7, 2022',
      shareWith: 'public',
      content: 'Anime : Anak ibu tirinya adalah mantan pacarnya',
      like: 15000,
      angry: 3,
      comment: 210,
      haha: 3000,
    ...
    Post(
      ...
      shareWith: 'public',
      content:
          'Bersamaku sampai aku tua jika kamu ingin kita menjadi tua juga..\n-\nMenjadi Tua Bersamaku Jika Kamu Juga Ingin Menjadi Tua Bersamaku\nHIEN MAI / Sesi Langsung…',
      like: 12000,
      angry: 1,
      comment: 902,
      haha: 21,
