...
import 'package:facebook/features/market_place/widgets/related_products.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  final TextEditingController messageController =
      TextEditingController(text: 'Barang ini sudah tidak tersedia lagi?');
  int _current = 0;
  @override
                  ...
                  Expanded(
                    child: RichText(
                        text: const TextSpan(
                            ...
                            children: [
                          TextSpan(text: 'Juga anggota dari'),
                          TextSpan(
                            text:
                                'UNIVERSITAS ILMU PENGETAHUAN ALAM - Universitas Nasional Kota Ho Chi Minh. HCM',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                            ),
                          ),
            ...
            const Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Bergabunglah dengan Facebook pada tahun 2017',
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 16,
                      ),
                ...
                children: [
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Pemberitahuan tentang daftar serupa',
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.w500,
                            color: Colors.black,
                        ...
                        Text(
                          'Dapatkan pemberitahuan ketika item ini terdaftar.',
                          maxLines: 2,
                          style: TextStyle(
                            color: Colors.black54,
                            fontSize: 17,
