                              ...
                              child: RichText(
                                ...
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text:
                                          'Mempelajari ${user.educations![i].majors != '' ? '${user.educations![i].majors} ' : ''}di dalam ',
                                      style: const TextStyle(
                                        fontWeight: FontWeight.w400,
                                      ),
                                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Memiliki ${user.followers} pengikut',
                              style: const TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.w400,
                                fontSize: 16,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            isMine
                                ? 'Lihat informasi referensi Anda'
                                : 'Lihat informasi pengantar dari ${user.name}',
                            style: const TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.w400,
                              fontSize: 16,
                  ...
                  if (user.type != 'page')
                    RichText(
                      ...
                      text: TextSpan(
                          ...
                          children: [
                            isMine
                                ? const TextSpan(text: ' teman ')
                                : mutualFriends > 0
                                    ? TextSpan(
                                        text: ' ($mutualFriends) teman bersama')
                                    : const TextSpan()
                          ]),
                    ),
                  if (user.type != 'page')
                      ...
                      Expanded(
                        child: Text(
                          isMine
                              ...
                              : 'Tulis sesuatu untukku ${user.name}',
                          style: const TextStyle(
                            fontSize: 16,
                            color: Colors.black,
                          ),
